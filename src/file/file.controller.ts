...
export class FileController {
  ...
  @RequireSpaceRole(SpaceRole.EDITOR, { source: 'body', key: 'spaceId' })
  ...
  @Get(':id')
  @UseGuards(SpaceRoleGuard)
  @RequireSpaceRole(SpaceRole.VIEWER, { source: 'file', param: 'id' })
  async download(
  ...
  @Delete(':id')
  @UseGuards(SpaceRoleGuard)
  @RequireSpaceRole(SpaceRole.MANAGER, { source: 'file', param: 'id' })
  @HttpCode(HttpStatus.NO_CONTENT)
  async remove(
    @Param('id') fileId: string,
    @Req() request: RequestWithUser,
