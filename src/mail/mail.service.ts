...
export class MailService {
  ...
  async sendPasswordResetEmail(email: string, token: string) {
    ...
    const html = `<p>You requested a password reset. Click <a href="http://localhost:3000/api/v1/auth/verify-reset-token?token=${token}">here</a> to reset your password.</p>
